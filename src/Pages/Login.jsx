            ...
            <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
              <form>
                ...
                <label>
                  ...
                  <input
                    type="email"
                    className="mt-2 mb-6 inline-block w-full rounded px-7 pb-2.5 pt-3 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out"
